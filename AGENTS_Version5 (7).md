# ArXiv Research Synthesizer - AI Agent Instructions
...
- https://arxiv.org/help/api/user-manual (arXiv API & guidance)  
- https://crawlee.dev (Crawlee documentation)  
- https://docs.apify.com (Apify docs)